...
const (
	...
	SendAcceptMessageReqCreatedEvent = "SendAcceptMessageReq.created"
	SendAcceptMessageReqSentEvent    = "SendAcceptMessageReq.sent"

	SendRejectMessageReqCreatedEvent = "SendRejectMessageReq.created"
	SendRejectMessageReqSentEvent    = "SendRejectMessageReq.sent"
)
