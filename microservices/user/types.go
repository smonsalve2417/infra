...
type UserStore interface {
	...
	GetSubscriptionTiers(creatorID primitive.ObjectID) ([]common.SubscriptionTiers, error)
	ConvertSubscriptionTierToPB(tier *common.SubscriptionTiers) *pb.SubscriptionTiers
	GetSubscriptionTiersAsPB(creatorID primitive.ObjectID) ([]*pb.SubscriptionTiers, error)
