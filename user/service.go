...
func (s *service) GetTierMembers(context.Context) error {
	return nil
}

func (s *service) UpdateName(context.Context) error {
	return nil
}

func (s *service) BanUser(context.Context) error {
	return nil
}

func (s *service) GetEarnings(context.Context) error {
	return nil
}

func (s *service) DeleteAccount(context.Context) error {
	return nil
}

func (s *service) UpdateDisplayName(context.Context) error {
	return nil
}

func (s *service) VerifyCreator(context.Context) error {
	return nil
}

func (s *service) GetSubEarnings(context.Context) error {
	return nil
}

func (s *service) RetrieveSub(context.Context) error {
	return nil
}
